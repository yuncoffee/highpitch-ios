...
struct MockModel {
    static let sampleProjects: [ProjectModel] = [
        ProjectModel(name: "Sample 1", creatAt: Date(), editAt: Date(), practices: [
            ...
            PracticeModel(name: "Practice 6", creatAt: Date(), analysis: PracticeAnlysis(), media: PracticeMedia(type: .audio)),
            PracticeModel(name: "Practice 7", creatAt: Date(), analysis: PracticeAnlysis(), media: PracticeMedia(type: .audio)),
            PracticeModel(name: "Practice 8", creatAt: Date(), analysis: PracticeAnlysis(), media: PracticeMedia(type: .audio)),
            PracticeModel(name: "Practice 9", creatAt: Date(), analysis: PracticeAnlysis(), media: PracticeMedia(type: .audio)),
            PracticeModel(name: "Practice 10", creatAt: Date(), analysis: PracticeAnlysis(), media: PracticeMedia(type: .audio)),
            PracticeModel(name: "Practice 11", creatAt: Date(), analysis: PracticeAnlysis(), media: PracticeMedia(type: .audio)),
            PracticeModel(name: "Practice 12", creatAt: Date(), analysis: PracticeAnlysis(), media: PracticeMedia(type: .audio)),
            PracticeModel(name: "Practice 13", creatAt: Date(), analysis: PracticeAnlysis(), media: PracticeMedia(type: .audio)),
            PracticeModel(name: "Practice 14", creatAt: Date(), analysis: PracticeAnlysis(), media: PracticeMedia(type: .audio)),
            PracticeModel(name: "Practice 15", creatAt: Date(), analysis: PracticeAnlysis(), media: PracticeMedia(type: .audio))
        ]),
